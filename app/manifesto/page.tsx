...
export default async function ManifestoPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-6 sm:px-6">
      <article className="space-y-3 text-sm leading-relaxed text-neutral-800 [&_a]:underline [&_a]:underline-offset-2 [&_h1]:font-serif [&_h1]:text-2xl [&_h1]:font-medium [&_h1]:tracking-tight [&_h1]:text-verde-950 sm:[&_h1]:text-3xl dark:[&_h1]:text-creme-50 [&_h2]:mt-4 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-verde-950 dark:[&_h2]:text-neutral-100 [&_h3]:font-semibold [&_li]:ml-4 [&_li]:list-disc [&_strong]:font-semibold dark:text-neutral-200">
